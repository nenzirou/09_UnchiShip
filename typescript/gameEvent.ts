...
export class GameEvent {
    ...
    texts: string[][] = [
        ["ここは宇宙のど真ん中。\n小さな星に小さな宇宙船がぽつり。", "船員のおじさん達は今日も元気に働き中。", "おじさんが地球を旅立ち１億年。\n地球には、もはや彼らを知る者は誰一人いない。", "そしておじさん達も、自分たちが何故宇宙を漂っているのか、まだ知らない。",
            "よう！新しい船の調子はどうだ？", "...どうやらやるき満々のようだな。", "いざ、チキューに向けて出発だ！", "チキューは我らが故郷！\n生きるために必要な水や食料がたくさん手に入る。", "我らが生き延びるために再びチキューの地へと足を踏み入れるのだ！",
            "おっと。この船にはまだエンジンがなかったな。", "たしかこの辺りに...",
            "あったあった。これがエンジ...ん？", "へへっ、間違えて別の素材を持ってきちまった。ぷりぷり。", "まあいいだろう。試しにこれで倉庫を作ってみよう！", "メニューの「建設」から倉庫のアイコンを選んで建設だ！",
            "無事倉庫が出来たみたいだな！\n宇宙にはたくさんのアイテムが散らばっている。倉庫はそのお宝を格納するために必須だ！", "っと、エンジンがいるんだったな。\n\n\n\n\n\nどれどれ...",
            "あったあった。今度こそエンジ...ん？", "へへへっ、また間違えちゃった。ぷりぷり。", "いや、ブラウザバックしないで！\nチュートリアルのためにわざと間違えることを強いられてるんだ！", "というわけで、今度はベッドを作ってみよう！",
            "おじさんとて、働けば休憩も必要になる。\nおじさんの数だけベッドを用意して、過労死しないように気を付けるんだ！", "おじさんの数を増やすのにもベッドが必要だぞ！\nどうやって増えるのかって？\n\n\n...コウノトリさんが運んでくるの。", "よし、今度こそエンジンを探してくるぞ。\n\n\n\nどれどれ...",
            "あったあった。\nこれぞ正真正銘のエンジ...ん？", "うん、まぎれもなくエンジンだ。\n最後にエンジンを作成してみよう！",
            "エンジンを作ると、FUELの最大値が増える。\nFUELがなくなると、考えるのをやめてもやめなくても永遠に宇宙を漂うことになるから気をつけろ。", "さあ、広大な宇宙へと旅立とう！\n「地図」から近くの星を選択して出発だ！"],
    ];
